...
<html lang="en">
	<head>
		...
		<script>var config = {base: "<?php echo BASEURL; ?>"};</script>
						...
						<div class="box1">
							<div class="wrapper">
								<section class="col2 pad_left1" style="width:800px">
									<span style="text-align:center;font-size:24px; line-height:1.5;font-weight:bold;l">
Thank you for registering to become a member church with Especially The Family! Please check your email to complete the registration process
									</span></section>
							</div>
						</div>	
					</div>
