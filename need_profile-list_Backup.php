				...
				<div class="box1">
                    ...
                    <?php
                        ...
                        <tr>
                        	...
                        	<td align="center" style="border:1px solid black;" ><?php echo $data[description]; ?></td>
                            ...
                            <td align="center" style="border:1px solid black;" ><?php if($data[status]==0) {?><a href="donation_request.php?did=<?php echo $data[member_donation_request_id]; ?>">Edit</a><?php } ?></td>
