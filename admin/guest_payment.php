...
$cnt =0;
$query = "select * from transaction_details a, member_register b where a.need_reuest_id=b.member_register_id and a.donor_id='guest' ";
if(!empty($_GET['srchtype'])){
$query .= " and $_GET[srchtype] like '%$_GET[srch]%'  ";
	}
$q=db_query($query);	
$total=db_num_rows($q);
$query .=" order by b.member_first_name limit $start, $len"; 
$q=db_query($query);
...
<div id="page-top">
	...
	<!--  start top-search -->
	<div id="top-search">
    <form name="myform2" id="myform2" method="GET" action="donor_register_payment.php">
...
<input type="text" name="srch" value="<?php if(!empty($_GET['srch'])) echo $_GET['srch']; else echo "Search"; ?>" onblur="if (this.value=='') { this.value='<?php if(!empty($_GET['srch'])) echo $_GET['srch']; else echo "Search"; ?>'; }" onfocus="if (this.value=='<?php if(!empty($_GET['srch'])) echo $_GET['srch']; else echo "Search"; ?>') { this.value=''; }" class="top-search-inp" /></td>
       ...
       <!-- <option value="All" selected="selected">All</option>--><?php  //} ?>
			<option value="b.donor_first_name">User Name</option>
			<option value="a.donor_email">Email</option>
		</select> 
		</td>
		<td>
...
<ul class="current"><li><a href="member_request_approved.php"><b>Reports</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
				<?php $mu=4; include_once("commonsubmenu.php");?>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		</ul>
		<div class="nav-divider">&nbsp;</div>
...
$_GET['error'] ="Record not selected ";		}			
				...
				<tr>
					...
					<th width="186" class="table-header-repeat line-left minwidth-1"><a href="">First Name</a>	</th>
					<th width="169" class="table-header-repeat line-left minwidth-1"><a href="">Last Name</a></th>
					<th width="207" class="table-header-repeat line-left"><a href="">Email</a></th>
					<th width="143" class="table-header-repeat line-left"><a href=""><span class="columnlink">Amount</span></a></th>
					<th width="284" class="table-header-repeat line-left">&nbsp;</th>
					<th width="142" class="table-header-repeat line-left"><!--<a href="">Actions</a>--></th>
				</tr>
<?php 
$i=1;
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					...
					<td align="left"><?php echo $r->member_last_name?></td>
					<td align="left"><?php echo $r->member_email?></td>
					<td align="left"><?php  echo $r->amount ?></td>
					<td align="left">&nbsp;</td>
					<td>
<!--<a href="member_request_view.php?id=<?php echo $r->member_donation_request_id; ?>" title="View" class="icon-3 info-tooltip"></a>
<!--<a href="member_request_approved_edit.php?id=<?php echo $r->member_register_id; ?>" title="Edit" class="icon-1 info-tooltip"></a>-->
<!--<a href="member_request.php?id=<?php echo $r->member_donation_request_id; ?>&delete=Record deleted sucessfully" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure you want to delete this record ?')"></a>--></td>
				</tr>
...
<? }?>
            ...
            <div id="actions-boxB">
				...
				<div id="actions-box-sliderB">
					<a href="donor_register_payment.php?numrows=5" class="action-deleteB" >5</a>
					<a href="donor_register_payment.php?numrows=10" class="action-deleteB" >10</a>
					<a href="donor_register_payment.php?numrows=25" class="action-deleteB" >25</a>
					<a href="donor_register_payment.php?numrows=50" class="action-deleteB" >50</a>
					<a href="donor_register_payment.php?numrows=75" class="action-deleteB" >75</a>
					<a href="donor_register_payment.php?numrows=100" class="action-deleteB" >100</a>
				</div>
				<div class="clear"></div>
			</div>
            				<div class="clear"></div>
