...
function CDelete_Click(PK)	{
	...
	{
	document.location="member_request_view.php?Action=Delete&pk="+PK+"&id="+PK;
	}
}
function CApprove_Click(PK)	{
document.location="member_request_view.php?Action=Approve&pk="+PK+"&id="+PK;
}

function CReject_Click(PK)	{
document.location="member_request_view.php?Action=Reject&pk="+PK+"&id="+PK;
}
</script>
<?php
// change-- query here
if($_REQUEST['Action'] =='Delete')
	{
		$id = $_REQUEST['pk'];
		$sql = db_query("DELETE FROM  member_donation_request  WHERE  member_donation_request_id = ".$id) or die(mysql_error);
	?>
<script>
window.location = 'member_request.php?delete=Record deleted sucessfully';
</script><?php }
if($_REQUEST['Action'] =='Reject'){
$id = $_REQUEST['pk'];
		$sql =db_query("Update member_donation_request  set status='2' where member_donation_request_id='".$_REQUEST['pk']."' ") or die(mysql_error);
?>
<script>
window.location = 'member_request.php?delete=Record Rejected sucessfully';
</script>
<?php }
if($_REQUEST['Action'] =='Approve'){
$id = $_REQUEST['pk'];
$sql =db_query("Update member_donation_request  set status='1', approve_date = sysdate() where member_donation_request_id='".$_REQUEST['pk']."' ") or die(mysql_error);
?>
<script>
...
$query = "select * from member_donation_request a, member_register b where a.member_register_id=b.member_register_id   and a.member_donation_request_id = '".$_SESSION['id']."'";
...
<div id="page-top">
	...
	<!--  start top-search -->
	<div id="top-search">
		    <form name="myform2" id="myform2" method="GET" action="member_request.php">
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				<li class="sub_show"><a href="#nogo" style="cursor:pointer">Church Accounts</a></li>
...
<h1>View details of <span style="text-transform:uppercase"><?php echo $r->title?></span></h1>	
</div>
			...
			<div id="table-content">
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				<tr>
			        ...
			        <h1 style="color:#FFF">Submitted Need Information</h1></div></th>
				  </tr>
             
				<tr>
					<td width="19%">Title</td>
					<td width="43%" align="left"><?php echo $r->title;?></td>
					<td width="38%" rowspan="12" align="right" valign="top">
                    <?php if(!empty($r->img)) { ?><img src="../upload/<?php echo $r->img; ?>"  width="400" height="400"/><?php } ?>
                    </td>
				  </tr>
				<tr>
				...
				<tr>
				  <td>Approved Date</td>
				  <td align="left"><span class="inputright"><?php if($r->approve_date !='') { echo date("m-d-Y",strtotime($r->approve_date)); }?></span></td>
				  </tr>
				<tr>
				  <td colspan="2" align="center"><strong style="font-size:18px">Church Information</strong></td>
				  </tr>
				<tr>
				  <td>Church Name</td>
				  <td align="left"><?php echo $r->church_name?></td>
				  </tr>
				<tr>
				  <td>Contact Person</td>
				  <td align="left"><?php echo $r->Contactperson?></td>
				  </tr>
				<tr>
...
<!--<tr>
				...
				<tr>
                  ...
                  <div align="center">
<?php if($r->status != '1') {?>
<input type="button" name="button" value="Approve"  onClick="JavaScript: CApprove_Click('<?php echo $r->member_donation_request_id; ?>');" style="background:url(images/login/inp_login.gif); color:#FFF; padding:2px; cursor:pointer; border:none" />
<?php  } ?>
<?php if($r->status != '2') {?>
<input type="button" name="button" value="Reject"  onClick="JavaScript: CReject_Click('<?php echo $r->member_donation_request_id; ?>');" style="background:url(images/login/inp_login.gif); color:#FFF; padding:2px; cursor:pointer; border:none" />
<?php  } ?>
<a href="member_donation_requsts_edit.php?id=<?php echo $_GET['id'];?>"><input type="button" name="button" value="Edit" style="background:url(images/login/inp_login.gif); color:#FFF; padding:2px; cursor:pointer; border:none" /></a>  

<input type="button" name="button" value="Delete"  onClick="JavaScript: CDelete_Click('<?php echo $r->member_donation_request_id; ?>');" style="background:url(images/login/inp_login.gif); color:#FFF; padding:2px; cursor:pointer; border:none" />
