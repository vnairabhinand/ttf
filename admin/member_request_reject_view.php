...
function CDelete_Click(PK)	{
	...
	{
	document.location="member_request_reject_view.php?Action=Delete&pk="+PK+"&id="+PK;
	}
}
function CApprove_Click(PK)	{
document.location="member_request_reject_view.php?Action=Approve&pk="+PK+"&id="+PK;
}

function CReject_Click(PK)	{
document.location="member_request_reject_view.php?Action=Reject&pk="+PK+"&id="+PK;
}
</script>
<?php
// change-- query here
if($_REQUEST['Action'] =='Delete')
	...
	?>
<script>
window.location = 'member_request_reject.php?delete=Record deleted sucessfully';
</script><?php }
...
?>
<script>
window.location = 'member_request_reject.php?delete=Record Rejected sucessfully';
</script>
<?php }
...
$query = "select * from member_donation_request a, member_register b where a.member_register_id=b.member_register_id   and  status='2' and a.member_donation_request_id = '".$_SESSION['id']."'";
...
<div id="page-top">
	...
	<!--  start top-search -->
	<div id="top-search">
		    <form name="myform2" id="myform2" method="GET" action="member_request_reject_view.php">
...
<ul class="current"><li><a href="donor_register_payment.php"><b>Reports</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li class="sub_show"><a style="cursor:pointer" href="member_request_reject.php">Rejected Needs</a></li>	
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
...
<a href="member_request_reject.php" title="Back" class="info-tooltip"><h2>BACK</h2></a>	
</div>
...
<!--<tr>
				...
				<tr>
                  ...
                  <div align="center">
<?php if($r->status == '2') {?>
<input type="button" name="button" value="Re-Approve"  onClick="JavaScript: CApprove_Click('<?php echo $r->member_donation_request_id; ?>');" style="background:url(images/login/inp_login.gif); color:#FFF; padding:2px; cursor:pointer; border:none" />
<?php  } ?>
                  </div>
                  </td>
				  </tr>                  
