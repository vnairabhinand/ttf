...
$sql =db_query("insert into admin ( admin_name, password, status ) values ('$admin_name', '$passwords', 'newadmin'  ) ") or die(mysql_error);
$set='ok';
}
?>
...
<!--<div class="select_sub show">
	  ...
	  <ul class="select"><li><a href="member_approved.php"><b>Admin</b><!--[if IE 7]><!--></a><!--<![endif]-->
		...
		</ul>        <?php if($_SESSION['status'] == "superadmin" ) {?>
 <div class="nav-divider">&nbsp;</div>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<td class="green-left"><?php echo "Record Inserted sucessfully" ?>.</td>
...
<form name="myform" id="myform" method="POST" action="">
				...
				<tr>
			        ...
			        <h1 style="color:#FFF">New Admin Manage</h1></a></div></th>
				  </tr>
             
				<tr>
					<td width="19%">Email ID</td>
					<td width="81%" align="left">
				    <input name="admin_name" type="text" id="admin_name"  /></td>
				  </tr>
				<tr>
				  <td>Password</td>
				  <td align="left">
				...
				<tr>
				  <td>&nbsp;</td>
				  <td align="left">
<input type="submit" name="submit" value="Create New Admin" style="background:url(images/login/inp_login.gif); color:#FFF; padding:2px; cursor:pointer; border:none" />
                  </td>
				  </tr>
