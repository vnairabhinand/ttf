...
for($i=0;$i<=$count;$i++){ 
$del_id = $user[$i][mid]; 
$as = "select * from member_register where member_register_id = '$del_id' ";
$qs=db_query($as);
$tota=db_num_rows($qs);
if($tota <> ''){
$del = db_query("delete from member_register  where member_register_id = '$del_id' ");
$_GET['delete'] ="Record deleted sucessfully";
}
}
if(!empty($_GET['id']))
	{
		$sql = db_query("DELETE FROM  member_register  WHERE  member_register_id = ".$_GET['id']) or die(mysql_error);
	    $_GET['delete'] ="Record deleted sucessfully";
	}
$cnt =0;
$query = "select * from member_register where is_approve ='0' ";
...
<div id="page-top">
	...
	<!--  start top-search -->
	<div id="top-search">
    <form name="myform2" id="myform2" method="GET" action="member_registration.php">
...
$_GET['error'] ="Record not selected ";		}			
				...
				<tr>
					...
					<th width="203" class="table-header-repeat line-left minwidth-1"><a href=""><span class="columnlink">User Name</span></a>	</th>
					<th width="135" class="table-header-repeat line-left minwidth-1"><a href="">Email</a></th>
					<th width="223" class="table-header-repeat line-left"><a href="">Church Name</a></th>
					<th width="157" class="table-header-repeat line-left"><a href="">Phone</a></th>
					<!--th width="124" class="table-header-repeat line-left"><a href="">Email Verify</a></th-->
					<th width="282" class="table-header-repeat line-left"><a href="">Address</a></th>
					<th width="131" class="table-header-repeat line-left"><a href="">Actions</a></th>
				</tr>
<?php 
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					<td><input  type="checkbox" class='checkall'  name='user[<? echo $i; ?>][mid]' value='<? echo $r->member_register_id; ?>'  /></td>
					...
					<td>
<a href="member_registration_view.php?id=<?php echo $r->member_register_id; ?>" title="View" class="icon-3 info-tooltip"></a>
<a href="member_registration_edit.php?id=<?php echo $r->member_register_id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
<a href="member_registration.php?id=<?php echo $r->member_register_id; ?>&delete=Record deleted sucessfully" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure you want to delete this record ?')"></a></td>
				</tr>
...
<?php }?>
            ...
            <div id="actions-boxB">
				...
				<div id="actions-box-sliderB">
					<a href="member_registration.php?numrows=5" class="action-deleteB" >5</a>
					<a href="member_registration.php?numrows=10" class="action-deleteB" >10</a>
					<a href="member_registration.php?numrows=25" class="action-deleteB" >25</a>
					<a href="member_registration.php?numrows=50" class="action-deleteB" >50</a>
					<a href="member_registration.php?numrows=75" class="action-deleteB" >75</a>
					<a href="member_registration.php?numrows=100" class="action-deleteB" >100</a>
				</div>
				<div class="clear"></div>
			</div>
            				<div class="clear"></div>
