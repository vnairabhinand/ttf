...
$cnt =0;
$query = "select * from member_donation_request a, member_register b where a.member_register_id=b.member_register_id   and  status='0' ";
...
<li class="sub_show"><a href="member_request.php" style="cursor:pointer">Submitted Needs 
<?php
...
<a href="member_donation_requsts_edit.php?id=<?php echo $r->member_donation_request_id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
...
<? }?>
            ...
            <div id="actions-boxB">
				...
				<div id="actions-box-sliderB">
					<a href="member_request.php?numrows=5" class="action-deleteB" >5</a>
					<a href="member_request.php?numrows=10" class="action-deleteB" >10</a>
					<a href="member_request.php?numrows=25" class="action-deleteB" >25</a>
					<a href="member_request.php?numrows=50" class="action-deleteB" >50</a>
					<a href="member_request.php?numrows=75" class="action-deleteB" >75</a>
					<a href="member_request.php?numrows=100" class="action-deleteB" >100</a>
				</div>
				<div class="clear"></div>
			</div>
            				<div class="clear"></div>
