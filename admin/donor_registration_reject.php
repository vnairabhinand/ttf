...
for($i=0;$i<=$count;$i++){ 
$del_id = $user[$i][mid]; 
$as = "select * from donor_register where donor_register_id = '$del_id' ";
$qs=db_query($as);
$tota=db_num_rows($qs);
if($tota <> ''){
$del = db_query("delete from donor_register  where donor_register_id = '$del_id' ");
$_GET['delete'] ="Record deleted sucessfully";
}
}
if(!empty($_GET['id']))
	{
		$sql = db_query("DELETE FROM  donor_register  WHERE  donor_register_id = ".$_GET['id']) or die(mysql_error);
	    $_GET['delete'] ="Record deleted sucessfully";
	}
$cnt =0;
$query = "select * from donor_register where is_approve ='2' ";
if(!empty($_GET['srchtype'])){
$query .= " and $_GET[srchtype] like '%$_GET[srch]%'  ";
	}
$q=db_query($query);	
$total=db_num_rows($q);
$query .=" order by donor_username limit $start, $len"; 
$q=db_query($query);
...
<div id="page-top">
	...
	<!--  start top-search -->
	<div id="top-search">
   <form name="myform2" id="myform2" method="GET" action="donor_registration_reject.php.php">
...
<ul class="current"><li><a href="member_request_approved.php"><b>Reports</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
	<?php $mu=6; include_once("commonsubmenu.php");?>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		</ul>
		<div class="nav-divider">&nbsp;</div>
...
$_GET['error'] ="Record not selected ";		}			
				...
				<tr>
					<th width="39" class="table-header-check"><input type='checkbox' class='checkall' onclick='toggle(this)' /> </th>
					<th width="239" class="table-header-repeat line-left minwidth-1"><a href=""><span class="columnlink">User Name</span></a>	</th>
					<th width="208" class="table-header-repeat line-left minwidth-1"><a href="">Email</a></th>
					<th width="123" class="table-header-repeat line-left"><a href="">Phone</a></th>
					<th width="140" class="table-header-repeat line-left"><a href="">Email Verify</a></th>
					<th width="287" class="table-header-repeat line-left"><a href="">Address</a></th>
					<th width="134" class="table-header-repeat line-left"><a href="">Actions</a></th>
				</tr>
<?php 
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					<td><input  type="checkbox" class='checkall'  name='user[<? echo $i; ?>][mid]' value='<? echo $r->donor_register_id; ?>'  /></td>
					<td align="left"><?php echo $r->donor_username?></td>
					<td align="left"><?php echo $r->donor_email?></td>
					<td align="left"><?php echo $r->donor_phone?></td>
					<td align="left"><?php  if($r->is_verify !=0){ echo "Verified"; }else{ echo "Not Verified";} ?></td>
					<td align="left"><?php echo $r->donor_address; ?></td>
					<td>
<a href="donor_registration_reject_view.php?id=<?php echo $r->donor_register_id; ?>" title="View" class="icon-3 info-tooltip"></a>
<!--<a href="donor_registration_approved_edit.php?id=<?php echo $r->donor_register_id; ?>" title="Edit" class="icon-1 info-tooltip"></a>-->
<a href="donor_registration_reject.php?id=<?php echo $r->donor_register_id; ?>&delete=Record deleted sucessfully" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure you want to delete this record ?')"></a></td>
				</tr>
...
<? }?>
            ...
            <div id="actions-boxB">
				...
				<div id="actions-box-sliderB">
					<a href="donor_registration_reject.php?numrows=5" class="action-deleteB" >5</a>
					<a href="donor_registration_reject.php?numrows=10" class="action-deleteB" >10</a>
					<a href="donor_registration_reject.php?numrows=25" class="action-deleteB" >25</a>
					<a href="donor_registration_reject.php?numrows=50" class="action-deleteB" >50</a>
					<a href="donor_registration_reject.php?numrows=75" class="action-deleteB" >75</a>
					<a href="donor_registration_reject.php?numrows=100" class="action-deleteB" >100</a>
				</div>
				<div class="clear"></div>
			</div>
            				<div class="clear"></div>
