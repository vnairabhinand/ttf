...
$cnt =0;
$query = "select * from member_donation_request a, member_register b where a.member_register_id=b.member_register_id   and  status='1' ";
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					...
					<td>
<a href="member_request_approved_view.php?id=<?php echo $r->member_donation_request_id; ?>" title="View" class="icon-3 info-tooltip"></a>
 <a href="member_request_approvedd_edit.php?id=<?php echo $r->member_donation_request_id; ?>" title="Edit" class="icon-1 info-tooltip"></a> 
<a href="member_request_approved.php?id=<?php echo $r->member_donation_request_id; ?>&delete=Record deleted sucessfully" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure you want to delete this record ?')"></a></td>
				</tr>
