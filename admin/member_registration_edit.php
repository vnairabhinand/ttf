...
extract($_POST);
if(isset($submit)){
$sql =db_query("Update member_register  set church_name = '$church_name', member_username = '$member_username', member_email = '$member_email', member_first_name = '$member_first_name', member_last_name = '$member_last_name', member_phone = '$member_phone', member_address = '$member_address', is_verify = '$is_verify', is_approve = '$is_approve'   where member_register_id='".$_SESSION['id']."' ") or die(mysql_error);
}
?>
<?php 
...
<form name="myform" id="myform" method="POST" action="">
				...
				<tr>
			        ...
			        <h1 style="color:#FFF">Member Users Information</h1></a></div></th>
				  </tr>
             
				<tr>
					<td width="19%">Church Name</td>
					<td width="81%" align="left">
				    <input name="church_name" type="text" id="church_name" value="<?php echo $r->church_name;?>" /></td>
				  </tr>
				<tr>
				  <td><span class="inputleft">User Name</span></td>
				  <td align="left">
				    <input name="member_username" type="text" id="member_username" value="<?php echo $r->member_username?>" /></td>
				  </tr>
				<tr>
				  <td><span class="inputleft">Email</span></td>
				  <td align="left">
				    <input name="member_email" type="text" id="member_email" value="<?php echo $r->member_email?>" /></td>
				  </tr>
				<tr>
				  <td><span class="inputleft">First Name</span></td>
				  <td align="left">
				    <input name="member_first_name" type="text" id="member_first_name" value="<?php echo $r->member_first_name;?>" /></td>
				  </tr>
				<tr>
				  <td><span class="inputleft">Last Name</span></td>
				  <td align="left"><span class="inputright">
				    <input name="member_last_name" type="text" id="member_last_name" value="<?php echo $r->member_last_name;?>" />
				  </span></td>
				  </tr>
				<tr>
				  ...
				  <td align="left"><span class="inputright">
				    ...
				    <input name="member_phone" type="text" id="member_phone" value="<?php  echo $r->member_phone; ?>" />
				  </span></td>
				  </tr>
				<tr>
				  ...
				  <td align="left"><span class="inputright">
				    ...
				    <textarea name="member_address" id="member_address" cols="45" rows="5"><?php  echo $r->member_address; ?></textarea>
				  </span></td>
				  </tr>
				<!--<tr>
