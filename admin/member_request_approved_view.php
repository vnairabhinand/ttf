...
function CDelete_Click(PK)	{
	...
	{
	document.location="member_request_approved_view.php?Action=Delete&pk="+PK+"&id="+PK;
	}
}
function CApprove_Click(PK)	{
document.location="member_request_approved_view.php?Action=Approve&pk="+PK+"&id="+PK;
}

function CReject_Click(PK)	{
document.location="member_request_approved_view.php?Action=Reject&pk="+PK+"&id="+PK;
}
</script>
<?php
// change-- query here
if($_REQUEST['Action'] =='Delete')
	...
	?>
<script>
window.location = 'member_request_approved.php?delete=Record deleted sucessfully';
</script><?php }
...
?>
<script>
window.location = 'member_request_approved.php?delete=Record Rejected sucessfully';
</script>
<?php }
if($_REQUEST['Action'] =='Approve'){
$id = $_REQUEST['pk'];
$sql =db_query("Update member_donation_request  set status='1' where member_donation_request_id='".$_REQUEST['pk']."' ") or die(mysql_error);
?>
<script>
...
$query = "select * from member_donation_request a, member_register b where a.member_register_id=b.member_register_id   and  status='1' and a.member_donation_request_id = '".$_SESSION['id']."'";
			...
			<div id="table-content">
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				<tr>
			        ...
			        <h1 style="color:#FFF">Member Request View Information</h1> </div></th>
				  </tr>
             
				<tr>
					<td width="19%">Title</td>
					<td width="43%" align="left"><?php echo $r->title;?></td>
					<td width="38%" rowspan="11" align="right" valign="top"><?php if(!empty($r->img)) { ?><img src="../upload/<?php echo $r->img; ?>"  width="400" height="400"/><?php } ?></td>
				  </tr>
				<tr>
				...
				<tr>
				  ...
				  <td align="left"><?php date("m-d-Y",strtotime($r->cdate)); ?></td>
				  </tr>
				<tr>
				  <td>Approved Date</td>
...
<tr>
				...
				<tr>
				  <td colspan="3">
                  <div align="center">
<input type="button" name="button" value="Edit"   onclick="location.href='member_request_approvedd_edit.php?id=<?php echo $r->member_donation_request_id; ?>';"style="background:url(images/login/inp_login.gif); color:#FFF; padding:2px; cursor:pointer; border:none" />                
