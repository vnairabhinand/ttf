...
if(!empty($_GET['id']))
	{
	    ...
	    $_GET['delete'] ="Record deleted sucessfully";
		//3 For delete
		$sq2 = db_query("update member_donation_request set status = '3'  WHERE  member_register_id = ".$_GET['id']) or die(mysql_error);
	
	}
$cnt =0;
$query = "select * from member_register where is_approve !='2' ";
...
$_GET['error'] ="Record not selected ";		}			
				...
				<tr>
					...
					<th width="178" class="table-header-repeat line-left minwidth-1"><a href=""><span class="columnlink">User Name</span></a>	</th>
					<th width="121" class="table-header-repeat line-left minwidth-1"><a href="">Email</a></th>
					<th width="200" class="table-header-repeat line-left"><a href="">Church Name</a></th>
					<th width="141" class="table-header-repeat line-left"><a href="">Phone</a></th>
					<th width="124" class="table-header-repeat line-left"><a href="">Approved</a></th>
...
<!--  start message-red --> 
<?php 
if(empty($r->member_username)){
?>
<tr class="classB"><td colspan="8">  
<div id="message-red">
<table border="0" width="100%" cellpadding="0" cellspacing="0">
<tr>
<td class="red-left">Message. <a href="">No records found.</a></td>
<td class="red-right"><a class="close-red"><img src="images/table/icon_close_red.gif"   alt="" /></a></td>
</tr>
</table>
</div>
...
<!--  end message-red -->			
                <tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					...
					<td align="left"><?php  if($r->is_approve !=0){ echo "Yes"; }else{ echo "No";} ?></td>
					<td align="left"><?php echo $r->member_address; ?></td>
					<td>
<a href="member_approved_view.php?id=<?php echo $r->member_register_id; ?>" title="View" class="icon-3 info-tooltip"></a>
<a href="member_approved_edit.php?id=<?php echo $r->member_register_id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
<a href="member_approved.php?id=<?php echo $r->member_register_id; ?>&delete=Record deleted sucessfully" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure you want to delete this record ?')"></a></td>
				</tr>
...
<? }?>
            ...
            <div id="actions-boxB">
				...
				<div id="actions-box-sliderB">
					<a href="member_approved.php?numrows=5" class="action-deleteB" >5</a>
					<a href="member_approved.php?numrows=10" class="action-deleteB" >10</a>
					<a href="member_approved.php?numrows=25" class="action-deleteB" >25</a>
					<a href="member_approved.php?numrows=50" class="action-deleteB" >50</a>
					<a href="member_approved.php?numrows=75" class="action-deleteB" >75</a>
					<a href="member_approved.php?numrows=100" class="action-deleteB" >100</a>
				</div>
				<div class="clear"></div>
			</div>
            				<div class="clear"></div>
