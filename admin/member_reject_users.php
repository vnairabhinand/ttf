...
<div id="page-top">
	...
	<!--  start top-search -->
	<div id="top-search">
    <form name="myform2" id="myform2" method="GET" action="member_reject_users.php">
...
<ul class="current"><li><a href="donor_register_payment.php"><b>Reports</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<?php $mu=5; include_once("commonsubmenu.php");?>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		</ul>
		<div class="nav-divider">&nbsp;</div>
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					...
					<td>
<a href="member_reject_users_view.php?id=<?php echo $r->member_register_id; ?>" title="View" class="icon-3 info-tooltip"></a>
<!--<a href="member_approved_edit.php?id=<?php echo $r->member_register_id; ?>" title="Edit" class="icon-1 info-tooltip"></a>-->
<a href="member_reject_users.php?id=<?php echo $r->member_register_id; ?>&delete=Record deleted sucessfully" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure you want to delete this record ?')"></a></td>
				</tr>
...
<? }?>
            ...
            <div id="actions-boxB">
				...
				<div id="actions-box-sliderB">
					<a href="member_reject_users.php?numrows=5" class="action-deleteB" >5</a>
					<a href="member_reject_users.php?numrows=10" class="action-deleteB" >10</a>
					<a href="member_reject_users.php?numrows=25" class="action-deleteB" >25</a>
					<a href="member_reject_users.php?numrows=50" class="action-deleteB" >50</a>
					<a href="member_reject_users.php?numrows=75" class="action-deleteB" >75</a>
					<a href="member_reject_users.php?numrows=100" class="action-deleteB" >100</a>
				</div>
				<div class="clear"></div>
			</div>
            				<div class="clear"></div>
