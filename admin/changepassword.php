...
<!--<div class="select_sub show">
	  ...
	  <ul class="select"><li><a href="member_approved.php"><b>Admin</b><!--[if IE 7]><!--></a><!--<![endif]-->
        ...
        <?php if($_SESSION['status'] == "superadmin" ) {?>
         <div class="nav-divider">&nbsp;</div>
        		<ul class="current"><li><a href="changepassword.php"><b>Settings</b><!--[if IE 7]><!--></a><!--<![endif]-->
        <!--[if lte IE 6]><table><tr><td><![endif]-->
<div class="select_sub show">
			<ul class="sub">
				<li><a style="cursor:pointer" href="changepassword.php">Change Password</a></li>
                				<li><a style="cursor:pointer" href="newadmin.php">New Admin Manage</a></li>
...
<?php if(!empty($_SESSION['signerror'])) {?>
				...
				<!--  start message-green -->
<?php if(!empty($_SESSION['signsuss'])) {?>
				<div id="message-green">
				<table border="0" width="100%" cellpadding="0" cellspacing="0">
				<tr>
					<td class="green-left"><?php echo  $_SESSION['signsuss']; ?>.</td>
...
?>				<form method="post" action="">
				...
				<tr>
					<th width="37" class="table-header-check"></th>
					<th colspan="6" class="table-header-repeat" align="center"><div align="center" style="color:#FFF; font-size:18px;">Change Password</div></th>
				  </tr>
      
				<tr class="classB">
					<td colspan="5">&nbsp;</td>
					<td width="134">User Name</td>
					<td width="994"><?php echo $r->admin_name; ?></td>
				  </tr>
                  				<tr class="classA">
					<td colspan="5">&nbsp;</td>
					<td>Old Password</td>
					<td>
					  <input type="text" name="passwordold" id="passwordold" /></td>
				  </tr>
                  				<tr class="classB">
					<td colspan="5">&nbsp;</td>
					<td>New Password</td>
					...
					<td><input type="passwordre" name="passwordre" id="passwordre" /></td>
				  </tr>
                                 				<tr class="classB">
					<td colspan="6">&nbsp;</td>
					<td><input type="submit" name="submit" value="Update"  style="background:url(images/login/inp_login.gif); color:#FFF; padding:2px; cursor:pointer; border:none" /></td>
				  </tr>
