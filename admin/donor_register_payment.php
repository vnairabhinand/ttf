...
$cnt =0;
$query = "select * from donor_register_payment a, donor_register b, transaction_details c where a.donor_register_id=c.donor_id and c.need_reuest_id=a.member_donation_request_id and   b.donor_register_id = a.donor_register_id ";
if(!empty($_GET['srchtype'])){
$query .= " and $_GET[srchtype] like '%$_GET[srch]%'  ";
	}
$q=db_query($query);	
$total=db_num_rows($q);
$query .=" order by b.donor_username limit $start, $len"; 
$q=db_query($query);
...
<ul class="current"><li><a href="donor_register_payment.php"><b>Reports</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<?php $mu=3; include_once("commonsubmenu.php");?>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		</ul>
		<div class="nav-divider">&nbsp;</div>
...
$_GET['error'] ="Record not selected ";		}			
				...
				<tr>
					...
					<th width="284" class="table-header-repeat line-left"><a href="">Donation Request Title</a></th>
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					...
					<td align="left"><?php echo $r->donor_last_name?></td>
