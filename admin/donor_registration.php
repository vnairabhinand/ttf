...
$cnt =0;
$query = "select * from donor_register where is_approve ='0' ";
...
$nawc=db_fetch_object($naac); echo "($nawc->cnt)"; ?></a>
		...
		<div class="nav-divider">&nbsp;</div>
<ul  class="select" ><li><a href="donor_register_payment.php"><b>Reports</b><!--[if IE 7]><!--></a>
 <!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
...
$_GET['error'] ="Record not selected ";		}			
				...
				<tr>
					...
					<th width="276" class="table-header-repeat line-left minwidth-1"><a href=""><span class="columnlink">User Name</span></a>	</th>
					<th width="236" class="table-header-repeat line-left minwidth-1"><a href="">Email</a></th>
					<th width="139" class="table-header-repeat line-left"><a href="">Phone</a></th>
					<!--<th width="140" class="table-header-repeat line-left"><a href="">Email Verify</a></th>-->
					<th width="326" class="table-header-repeat line-left"><a href="">Address</a></th>
					<th width="154" class="table-header-repeat line-left"><a href="">Actions</a></th>
				</tr>
<?php 
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					...
					<td>
<a href="donor_registration_view.php?id=<?php echo $r->donor_register_id; ?>" title="View" class="icon-3 info-tooltip"></a>
<a href="donor_registration_edit.php?id=<?php echo $r->donor_register_id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
<a href="donor_registration.php?id=<?php echo $r->donor_register_id; ?>&delete=Record deleted sucessfully" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure you want to delete this record ?')"></a></td>
				</tr>
...
<? }?>
            ...
            <div id="actions-boxB">
				...
				<div id="actions-box-sliderB">
					<a href="donor_registration.php?numrows=5" class="action-deleteB" >5</a>
					<a href="donor_registration.php?numrows=10" class="action-deleteB" >10</a>
					<a href="donor_registration.php?numrows=25" class="action-deleteB" >25</a>
					<a href="donor_registration.php?numrows=50" class="action-deleteB" >50</a>
					<a href="donor_registration.php?numrows=75" class="action-deleteB" >75</a>
					<a href="donor_registration.php?numrows=100" class="action-deleteB" >100</a>
				</div>
				<div class="clear"></div>
			</div>
            				<div class="clear"></div>
