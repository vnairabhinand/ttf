...
$_GET['error'] ="Record not selected ";		}			
				...
				<tr>
					...
					<th width="211" class="table-header-repeat line-left minwidth-1"><a href=""><span class="columnlink">User Name</span></a>	</th>
					<th width="184" class="table-header-repeat line-left minwidth-1"><a href="">Email</a></th>
					<th width="110" class="table-header-repeat line-left"><a href="">Phone</a></th>
					<th width="85" class="table-header-repeat line-left"><a href="">Approved</a></th>
					<th width="150" class="table-header-repeat line-left"><a href="">Terms & Conditions</a></th>
                    					<th width="282" class="table-header-repeat line-left"><a href="">Address</a></th>
					<th width="109" class="table-header-repeat line-left"><a href="">Actions</a></th>
				</tr>
<?php 
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
					...
					<td align="left"><?php  if($r->is_approve !=1){ echo "No"; }else{ echo "Yes";} ?></td>
					<td align="left"><?php  if($r->Iagree !=1){ echo "Not Agreed"; }else{ echo "Agreed";} ?></td>
                    <td align="left"><?php echo $r->donor_address; ?></td>
					<td>
<a href="donor_registration_approved_view.php?id=<?php echo $r->donor_register_id; ?>" title="View" class="icon-3 info-tooltip"></a>
<a href="donor_registration_approved_edit.php?id=<?php echo $r->donor_register_id; ?>" title="Edit" class="icon-1 info-tooltip"></a>
<a href="donor_registration_approved.php?id=<?php echo $r->donor_register_id; ?>&delete=Record deleted sucessfully" title="Delete" class="icon-2 info-tooltip" onclick="return confirm('Are you sure you want to delete this record ?')"></a></td>
				</tr>
...
<? }?>
            ...
            <div id="actions-boxB">
				...
				<div id="actions-box-sliderB">
					<a href="donor_registration_approved.php?numrows=5" class="action-deleteB" >5</a>
					<a href="donor_registration_approved.php?numrows=10" class="action-deleteB" >10</a>
					<a href="donor_registration_approved.php?numrows=25" class="action-deleteB" >25</a>
					<a href="donor_registration_approved.php?numrows=50" class="action-deleteB" >50</a>
					<a href="donor_registration_approved.php?numrows=75" class="action-deleteB" >75</a>
					<a href="donor_registration_approved.php?numrows=100" class="action-deleteB" >100</a>
				</div>
				<div class="clear"></div>
			</div>
            				<div class="clear"></div>
