...
function CDelete_Click(PK)	{
	...
	{
	document.location="member_reject_users_view.php?Action=Delete&pk="+PK+"&id="+PK;
	}
}
function CApprove_Click(PK)	{
document.location="member_reject_users_view.php?Action=Approve&pk="+PK+"&id="+PK;
}

function CReject_Click(PK)	{
document.location="member_reject_users_view.php?Action=Reject&pk="+PK+"&id="+PK;
}
</script>
<?php
// change-- query here
if($_REQUEST['Action'] =='Delete')
	...
	?>
<script>
window.location = 'member_reject_users.php?delete=Record deleted sucessfully';
</script><?php }
...
?>
<script>
window.location = 'member_reject_users.php?delete=Record Rejected sucessfully';
</script>
<?php }
...
<a href="member_reject_users.php" title="Back" class="info-tooltip"><h2>BACK</h2></a>	
</div>
