...
$_GET['error'] ="Record not selected ";		}			
				...
				<tr>
					...
					<th width="251" class="table-header-repeat line-left minwidth-1"><a href=""><span class="columnlink">Donor Name</span></a>	</th>
					<th width="291" class="table-header-repeat line-left minwidth-1"><a href="">Address</a></th>
					<th width="145" class="table-header-repeat line-left"><a href="">Phone</a></th>
					<th width="237" class="table-header-repeat line-left"><a href="">Email</a></th>
					<th width="110" class="table-header-repeat line-left"><a href="">Verify</a></th>
					<th width="97" class="table-header-repeat line-left"><a href="">Loged Details</a></th>
				</tr>
<?php 
$i=1;
...
?>               
				<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
                    ...
                    <?php echo $i; ?></td>
					<td align="left"><?php echo $r->donor_first_name." ".$r->donor_last_name?></td>
					<td align="left"><?php echo $r->donor_address?></td>
					<td align="left"><?php echo $r->donor_phone?></td>
					<td align="left"><?php echo $r->donor_email?></td>
					<td align="left"><?php if($r->is_verify == 1 ) echo 'verified'?></td>
					<td>
<a href="donoraccounts_view.php?id=<?php echo $r->donor_register_id; ?>" title="View" class="icon-3 info-tooltip"></a>
