...
function CDelete_Click(PK)	{
	...
	{
	document.location="member_approved_view.php?Action=Delete&pk="+PK+"&id="+PK;
	}
}
function CApprove_Click(PK)	{
document.location="member_approved_view.php?Action=Approve&pk="+PK+"&id="+PK;
}

function CReject_Click(PK)	{
document.location="member_approved_view.php?Action=Reject&pk="+PK+"&id="+PK;
}
</script>
<?php
// change-- query here
if($_REQUEST['Action'] =='Delete')
	...
	?>
<script>
window.location = 'member_approved.php?delete=Record deleted sucessfully';
</script><?php }
...
?>
<script>
window.location = 'member_approved.php?delete=Record Rejected sucessfully';
</script>
<?php }
...
<a href="member_approved.php" title="Back" class="info-tooltip"><h2>BACK</h2></a>	
</div>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				<tr>
				  <td><span class="inputleft">Password</span></td>
				  <td align="left"><?php echo $r->member_password;?></td>
				  </tr>
				<tr>
