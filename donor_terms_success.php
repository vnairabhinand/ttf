			...
			<div class="wrapper">
				...
				<div class="box1">
					...
					<div class="wrapper">
                        ...
                        <span style="text-align:center;font-size:24px; line-height:1.5;font-weight:bold; ">Thank you for accepting terms and conditions to become a donor with ETF. Please wait for the confirmation email which will be received within 48 hours</span></section>
