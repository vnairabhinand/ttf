...
<?php if(!empty($data['img'])) { ?><div align="center"> <img src="upload/<?php echo $data['img']; ?>" ></div><br>  <?php } ?>
<div align="center"><strong style="font-size:16px"><?php echo $data['title']; ?></strong></div><br>
