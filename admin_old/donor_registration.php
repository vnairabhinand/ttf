...
<?php
...

	{
		...
		echo "<script>location.href='donor_registration.php?visible=$res';</script>";
...
<script type="text/javascript" language="javascript">
...

	{
		...
		popupWindowURL('donor_registration_view.php?Action=View&pk='+PK, 'list', 600, 500, false, false, true);
				  ...
				  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
					 ...
					 if($_REQUEST["c"]!="")
					  	...
					  	$str .= " and donor_username like '" . $_REQUEST["c"] . "%'";
...

					{
						...
						$str .= " and donor_username like '" . $_REQUEST["search"] . "%'";
					  ...
					  $query = "select * from " . $table_name . " where 1=1 and is_approve='0' $str order by donor_username";
						  ...
						  <tr>
							...
							<table border="0" cellpadding="0" cellspacing="1" width="100%">
                                ...
                                <tr>
                                  ...
                                  <td width="20%" height="25" align="center" nowrap="nowrap" class="columnlink">View</td>
...
$slno=0;
								...
								?>
											...
											<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
											  ...
											  <td align="center"><?php /*<input type="checkbox" name="pk_list[]" id="pk_list[]" class="stdCheckBox" value="<?php echo $a["donor_register_id"]; ?>"/> */ echo $slno;  ?>                               </td>
								  ...
								  <?php echo $a["donor_address"]; ?> 
											  ...
											  <td align="center" nowrap="nowrap" style="padding: 0px 3px;"><table width="100" border="0" cellspacing="2" cellpadding="0">
												  ...
												  <tr>
													...
													<td><img src="images/icon_view.gif" alt="View" class="pointer" width="18" height="18" border="0" title="View Content" onClick="JavaScript: CView_Click(document.frmStdForm, '<?php echo $a[$table_name . "_id"]; ?>');" /> View</td>
