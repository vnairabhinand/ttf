...
$table_name = "donor_register_payment";
...
if($_REQUEST['Action'] =='Decline')
	{
		...
		mysql_query("Update member_donation_request set donor_payment_status='2' where member_donation_request_id='".$_REQUEST['pk']."' "); 
...

	{
		...
		$sql = mysql_query("UPDATE " . $table_name .  " SET donor_payment_status = ". $visibility ." WHERE " . $table_name . "_id IN ('". $idList. "')") or die(mysql_error);
		if($visibility ==1)
...

	{
		...
		$id		 = $_REQUEST['pk'];
		mysql_query("update " . $table_name . " set donor_payment_status=$visible where " . $table_name . "_id=$id") or die(mysql_error());
		...
		echo "<script>location.href='donor_register_payment.php?visible=$res';</script>";
...
if($_POST['Save'])
	{		
      	mysql_query("Update member_donation_request set donor_payment_status='2',reason='".$_REQUEST['reason']."' where member_donation_request_id ='".$_REQUEST['pk']."' "); 
...
<script type="text/javascript" language="javascript">
	...
	function Toggle_Click(frm, PK, donor_payment_status, Field)

	{
...

		{
			...
			visible.value	= donor_payment_status;
...
<?php
...

	{
		...
		//$query 	= mysql_query("select * from " . $table_name . " as dr  join donor_register as mr on mr.donor_register_id = dr.donor_register_id  where  1=1 $str");
	//	$query 	= mysql_query("select * from " . $table_name . " as mdr  join member_register as mr on mr.member_register_id = mdr.member_register_id  where ". $table_name .  "_id =".$_GET['pk']) or die(mysql_error());
		...
		//$rs	= mysql_fetch_array($query);
$query = "select * from " . $table_name . " as dr  join donor_register as mr on mr.donor_register_id = dr.donor_register_id  where  1=1 $str";
								...
								<td>
									...
									<table border="0" cellpadding="3" cellspacing="1" width="95%" align="center">
                                        ...
                                        <tr>
											...
											<td class="inputleft" width="25%" valign="top" align="left">First Name</td>
                                        ...
                                        <tr>
											...
											<td class="inputleft" width="25%" valign="top" align="left">Last Name</td>

											<td class="inputright" align="left"><span style="padding: 0px 3px;"><?php echo $rs["donor_last_name"]; ?></span></td>
										</tr>
                                        
                                        <tr>

											<td class="inputleft" width="25%" valign="top" align="left">Email</td>

											<td class="inputright" align="left"><span style="padding: 0px 3px;"><?php echo $rs["donor_email"]; ?></span></td>
										</tr>
                                        
                                        
										<tr>

											<td class="inputleft" width="25%" valign="top" align="left">Donor Payment Data</td>

											<td class="inputright" align="left"><?php echo $rs['donor_payment_data'];?> </td>
										</tr>
                                        

										<tr>

											<td class="inputleft" width="25%" valign="top" align="left">Donor Payment Amount</td>

											<td class="inputright" align="left"><?php echo $rs['donor_payment_amount'];?> </td>
										</tr>
										  ...
										  <?php 
										  if($rs['donor_payment_status']==1)
										  {
										   echo "Approved";	  
										  }
										  
										  if($rs['donor_payment_status']==0)
										  {
											echo "DisApproved";	    
										  }
										  ?></td>
                                        ...
                                        <tr>
											...
											<td class="inputleft" width="25%" valign="top" align="left">Donor Request Title</td>

											<td class="inputright" align="left">
											  <?php
$m_q=mysql_query("select * from  member_donation_request WHERE member_donation_request_id=".$rs["member_donation_request_id"]); 
								  $m_data=mysql_fetch_array($m_q);
								  ...
								  ?>
                                        ...
                                        <tr>
											...
											<td class="inputright" align="left"><?php 
											$m_q=mysql_query("select * from  member_donation_request WHERE member_donation_request_id=".$rs["member_donation_request_id"]); 
								  $m_data=mysql_fetch_array($m_q);
											echo $m_data['description'];?> </td>
										</tr>				
						  ...
						  <tr>
							...
							<table border="0" cellpadding="0" cellspacing="1" width="100%">
                                ...
                                <tr>
                                  ...
                                  <td width='4%' height="25" align="center" class="columnlink">&nbsp;</td>
								  
                                  <td width='16%' height="25" align="center" nowrap="nowrap" class='columnlink'>First Name</td>
								  <td width='14%' height="25" align="center" nowrap="nowrap" class='columnlink'>Last Name</td> 
                                  <td width='12%' height="25" align="center" nowrap="nowrap" class='columnlink'>Email</td> 
								  <td width='21%' height="25" align="center" nowrap="nowrap" class='columnlink'>Guest Payment Status</td>
                                  <td width='27%' height="25" align="center" nowrap="nowrap" class='columnlink'>Amount</td>
                                  <td width='20%' height="25" align="center" nowrap="nowrap" class='columnlink'>Donation Request Title</td>
								  <td width="6%" height="25" align="center" nowrap="nowrap" class="columnlink">Action</td>
                                </tr>
                                ...
                                <td align="center" style="padding: 0px 3px;"><?php echo $a["donor_first_name"]; ?></td>			  								  <td align="center" style="padding: 0px 3px;"><?php echo $a["donor_last_name"]; ?></td>
                                   <td align="center" style="padding: 0px 3px;"><?php echo $a["donor_email"]; ?></td>
                                   
                                  
                                   <td align="center" style="padding: 0px 3px;"><?php $q=mysql_query("select * from donor_register_payment"); $a=mysql_fetch_array($q); if($a["guest_payment_status"]==1) { echo "Paid"; } else { echo "Unpaid"; } ?></td>	
                                  <td align="center" style="padding: 0px 3px;"><?php $q=mysql_query("select * from donor_register_payment"); $a=mysql_fetch_array($q); echo $a["donor_payment_amount"]; ?></td>
                                  <td align="center" style="padding: 0px 3px;">
								 <?php
	$m_q=mysql_query("select * from  member_donation_request WHERE member_donation_request_id=".$a["member_donation_request_id"]); 
								  $m_data=mysql_fetch_array($m_q);
								  
								  echo $m_data["title"]; 
								  ?>
                                  </td>
                                <td><img src="images/icon_view.gif" alt="View" class="pointer" width="18" height="18" border="0" title="View Content" onClick="JavaScript: CView_Click(document.frmStdForm, '<?php echo $a["member_donation_request_id"]; ?>');" />View</td>
                            </tr>
							<?php
								}
							}
