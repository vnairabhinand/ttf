...
function CDelete_Click(PK)

	{
...

			{
				...
				document.location="member_registration_view.php?Action=Delete&pk="+PK;
...
function CApprove_Click(PK)

	{
				...
				document.location="member_registration_view.php?Action=Approve&pk="+PK;
...
function CReject_Click(PK)

	{
				...
				document.location="member_registration_view.php?Action=Reject&pk="+PK;
...
<input type="button" name="button" value="Approve" class="button" onClick="JavaScript: CApprove_Click('<?php echo $rs["member_register_id"]; ?>');" />
<?php  } ?>
<?php if($rs['is_approve']!='2') {?>
						<input type="button" name="button" value="Reject" class="button" onClick="JavaScript: CReject_Click('<?php echo $rs["member_register_id"]; ?>');" />
<?php  } ?>
						<input type="button" name="button" value="Delete" class="button" onClick="JavaScript: CDelete_Click('<?php echo $rs["member_register_id"]; ?>');" />
