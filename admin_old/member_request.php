...
<script src="SpryAssets/SpryValidationTextField.js" typtd>
				...
				<tr>
				  ...
				  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
...

					{
						...
						$str .= " ane="text/javascript"></script>
...
<script type="text/javascript" language="javascript">
...

	{
		...
		popupWindowURL('member_request_view.php?Action=View&pk='+PK, 'list', 600, 500, false, false, true);
...
<?php
	...
	{
		// change-- query here
		$query 	= mysql_query("select * from " . $table_name . " where " . $table_name .  "_id =".$_GET['pk']."and status='0'") or die(mysql_error());
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<td height="370" align="center" valign="top"><br />
                    ...
                    <tr>
                      <td background="images/home_box_lbg.jpg">&nbsp;</d title like '" . $_REQUEST["search"] . "%'";
					  ...
					  $query = "select * from " . $table_name . " as mdr  join member_register as mr on mr.member_register_id = mdr.member_register_id  where  1=1 $str and status='0'";
						  ...
						  <tr>
							...
							<table border="0" cellpadding="0" cellspacing="1" width="100%">
                                ...
                                <tr>
                                  ...
                                  <td width='20%' height="25" align="center" nowrap="nowrap" class='columnlink'>Member Email</td>
								...
								?>
											...
											<tr class="<?php if($cnt==0) echo "classB"; else { ?>classA<?php } ?>">
											 ...
											 <td align="center">
											 <?php echo $slno; ?>
											<!-- <input type="checkbox" name="pk_list[]" id="pk_list[]" class="stdCheckBox" value="<?php //echo $a["member_donation_request_id"]; ?>"/>   
-->                               
