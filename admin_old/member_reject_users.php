...
<?php
...

	{
		...
		$query 	= mysql_query("select * from " . $table_name . " where " . $table_name .  "_id =".$_GET['pk']."and is_approve !='2'") or die(mysql_error());
				...
				<tr>
				  ...
				  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
...

					{
					  ...
					  $query = "select * from " . $table_name . " where 1=1 $str and is_approve ='2' order by member_username ";
