...
<?php
	...
	{
		// change-- query here
		$query 	= mysql_query("select * from " . $table_name . " where " . $table_name .  "_id =".$_GET['pk']."and status='1'") or die(mysql_error());
				...
				<tr>
				  ...
				  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
...

					{
					  ...
					  $query = "select * from " . $table_name . " as mdr  join member_register as mr on mr.member_register_id = mdr.member_register_id  where  1=1 $str and status='1'";
