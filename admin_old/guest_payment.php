...
<?php
...

	{
		...
		$sql = mysql_query("UPDATE " . $table_name .  " SET guest_payment_status = ". $visibility ." WHERE " . $table_name . "_id IN ('". $idList. "')") or die(mysql_error);
		if($visibility ==1)
...

	{
		...
		$id		 = $_REQUEST['pk'];
		mysql_query("update " . $table_name . " set guest_payment_status=$visible where " . $table_name . "_id=$id") or die(mysql_error());
		...
		echo "<script>location.href='guest_payment.php?visible=$res';</script>";
									...
									<table border="0" cellpadding="3" cellspacing="1" width="95%" align="center">
										...
										<tr>
                                         ...
                                         <tr>
                                          ...
                                          <td class="inputright" align="left"><?php echo $rs['guest_payment_first_name'];?></td>
                                        </tr>
                                         ...
                                         <tr>
                                          ...
                                          <td class="inputright" align="left"><?php echo $rs['guest_payment_last_name'];?></td>
                                        </tr>
										<tr>

                                          <td class="inputleft" valign="top" align="left">Email</td>

                                          <td class="inputright" align="left"><?php echo $rs['guest_payment_email'];?></td>
                                        </tr>
                                        <tr>

											<td class="inputleft" width="25%" valign="top" align="left">Guest Payment Data</td>

											<td class="inputright" align="left"><?php  echo $rs['guest_payment_data']; ?></td>
										</tr>

										<tr>

											<td class="inputleft" width="25%" valign="top" align="left">Guest Payment Amount</td>

											<td class="inputright" align="left"><?php  echo $rs['guest_payment_amount']; ?></td>
										</tr>
										<tr>
											...
											<td class="inputright" align="left"><?php if($rs['guest_payment_status']=='1') echo 'Yes'; else echo 'No';?> </td>
										</tr>
				  ...
				  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
					 ...
					 if($_REQUEST["c"]!="")
					  	...
					  	$str .= " and guest_payment_first_name like '" . $_REQUEST["c"] . "%'";

					if($_REQUEST["search"]!="")

					{

						$str .= " and guest_payment_first_name like '" . $_REQUEST["search"] . "%'";
					  ...
					  //$query = "select * from " . $table_name . " where 1=1 $str order by guest_payment_first_name";
$query = "select * from transaction_details where donor_id='guest'";
						  ...
						  <tr>
							...
							<table border="0" cellpadding="0" cellspacing="1" width="100%">
                                ...
                                <tr>
                                  ...
                                  <td width='10%' height="25" align="center" nowrap="nowrap" class='columnlink'>First Name</td>
								 <!-- <td width='15%' height="25" align="center" nowrap="nowrap" class='columnlink'>Last Name</td> 
                                  <td width='15%' height="25" align="center" nowrap="nowrap" class='columnlink'>Email</td> 
								  <td width='20%' height="25" align="center" nowrap="nowrap" class='columnlink'>Guest Payment Status</td>
                                  <td width='15%' height="25" align="center" nowrap="nowrap" class='columnlink'>Amount</td>
                                  <td width='20%' height="25" align="center" nowrap="nowrap" class='columnlink'>Donation Request Title</td>
								  <td width="5%" height="25" align="center" nowrap="nowrap" class="columnlink">Action</td>-->
...
$query = "select * from transaction_details where donor_id='guest'";
...
$info = mysql_query("$query  limit $ppos,$psize") or die(mysql_error());
								...
								?>
										...
										<?php	/*  <td align="center"><input type="checkbox" name="pk_list[]" id="pk_list[]" class="stdCheckBox" value="<?php echo $a["member_register_id"]; ?>"/>                                  </td>

                                  <td align="center" style="padding: 0px 3px;"><?php echo $a["guest_payment_first_name"]; ?></td>			  								  <td align="center" style="padding: 0px 3px;"><?php echo $a["guest_payment_last_name"]; ?></td>
                                   <td align="center" style="padding: 0px 3px;"><?php echo $a["guest_payment_email"]; ?></td>
                                   <td align="center" style="padding: 0px 3px;"><?php if($a["guest_payment_status"]==1) { echo "Paid"; } else { echo "Unpaid"; } ?></td>	
                                  <td align="center" style="padding: 0px 3px;"><?php echo $a["guest_payment_amount"]; ?></td>	
	...
	$m_q=mysql_query("select * from  member_donation_request WHERE member_donation_request_id=".$a["member_donation_request_id"]); 
								  ...
								  ?>
                                        	...
                                        	<td align="center"><img src="images/icon_view.gif" alt="View" class="pointer" width="18" height="18" border="0" title="View Content" onClick="JavaScript: CView_Click(document.frmStdForm, '<?php echo $a[$table_name . "_id"]; ?>');" /></td>*/?>
 <td align="center" style="padding: 0px 3px;"><?php echo $a["donor_id"]; ?></td>
 <td align="center" style="padding: 0px 3px;"><?php echo $a["amount"]." ".$a["currency"]  ; ?></td>
