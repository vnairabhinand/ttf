...
$str = "";
...

					{
					  ...
					  // change-- query here
					  //echo "select * from " . $table_name . " as dr  join donor_register as mr on mr.donor_register_id = dr.donor_register_id  where  1=1 $str";
						//$query = "select * from " . $table_name ;
					 $query = "select * from donor_register_payment as dr join donor_register as mr on mr.donor_register_id = dr.donor_register_id where 1=1";
