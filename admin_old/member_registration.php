...
$table_name = "member_register";



$title="Pending Church Accounts";
...
if($_REQUEST['Action'] =='Delete')
{
	...
	echo "<script>window.location='$page?delete=true'</script>";
	exit();
}
...
elseif($_REQUEST['Action'] =='VisibleHideSelected')
{
	...
	$sql = mysql_query("UPDATE " . $table_name .  " SET is_approve = ". $visibility ." WHERE " . $table_name . "_id IN ('". $idList. "')") or die(mysql_error);
	if($visibility ==1)
	{
	$res = 'true';
	}
...
elseif($_REQUEST['Action']=='VisibleHide')
{
	...
	$id		 = $_REQUEST['pk'];
	mysql_query("update " . $table_name . " set is_approve=$visible where " . $table_name . "_id=".$id) or die(mysql_error());
	if($visible ==1)
	{
	$res = 'true';
	}
	...
	echo "<script>location.href='member_registration.php?visible=$res';</script>";
	exit();
}
	$msg="";
	if($_GET["delete"]=="true")
...
<script type="text/javascript" language="javascript">
...

	{
		...
		popupWindowURL('member_registration_view.php?Action=View&pk='+PK, 'list', 600, 500, false, false, true);
...
<?php
...

	{
		...
		$query 	= mysql_query("select * from " . $table_name . " where " . $table_name .  "_id =".$_GET['pk']."and is_approve ='0'") or die(mysql_error());
								...
								<td>
									...
									<table border="0" cellpadding="3" cellspacing="1" width="95%" align="center">
										...
										<tr>
											...
											<td class="inputleft" width="25%" valign="top" align="left">Church Name</td>



											<td class="inputright" align="left"><?php echo $rs['church_name'];?> </td>
										...
										<tr>
											...
											<td class="inputright" align="left"><?php echo $rs['member_username'];?> </td>
                                        ...
                                        <tr>
                                          ...
                                          <td class="inputright" align="left"><?php echo $rs['member_email'];?></td>
                                         ...
                                         <tr>
                                          ...
                                          <td class="inputright" align="left"><?php echo $rs['member_first_name'];?></td>
                                         ...
                                         <tr>
                                          ...
                                          <td class="inputright" align="left"><?php echo $rs['member_last_name'];?></td>
                                        ...
                                        <tr>
											...
											<td class="inputright" align="left"><?php  echo $rs['member_phone']; ?></td>
										...
										<tr>
											...
											<td class="inputright" align="left"><?php  echo $rs['member_address']; ?></td>
				  ...
				  <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
					 ...
					 if($_REQUEST["c"]!="")
					  	...
					  	$str .= " and member_username like '" . $_REQUEST["c"] . "%'";
...

					{
						...
						$str .= " and member_username like '" . $_REQUEST["search"] . "%'";
					  ...
					  $query = "select * from " . $table_name . " where 1=1 $str and is_approve ='0' order by member_username ";
						  ...
						  <tr>
							...
							<table border="0" cellpadding="0" cellspacing="1" width="100%">
                                ...
                                <tr>
                                  ...
                                  <td width='10%' height="25" align="center" nowrap="nowrap" class='columnlink'>Username</td>



                                  <td width='15%' height="25" align="center" nowrap="nowrap" class='columnlink'>Email</td> 

                                  <td width='15%' height="25" align="center" nowrap="nowrap" class='columnlink'>Church Name</td> 



                                  <td width='20%' height="25" align="center" nowrap="nowrap" class='columnlink'>Phone</td>

                                  <td width='20%' height="25" align="center" nowrap="nowrap" class='columnlink'>Email Verify</td>



                                  <td width='30%' height="25" align="center" nowrap="nowrap" class='columnlink'>Address</td>             
								...
								?>
											...
											<!--  <input type="checkbox" name="pk_list[]" id="pk_list[]" class="stdCheckBox" value="<?php echo $a["member_register_id"]; ?>"/>   -->
											<?php echo $slno; ?> 
											</td>
								  ...
								  <?php echo $a["church_name"]; ?> 
                                   ...
                                   <td align="center" style="padding: 0px 3px;">
                                    ...
                                    <td align="center" style="padding: 0px 3px;">
										...
										<?php  if($a["is_verify"]!=0){ echo "Verified"; }else{ echo "Not Verified";} ?>
								  ...
								  <?php echo $a["member_address"]; ?> 
											  ...
											  <td align="center" nowrap="nowrap" style="padding: 0px 3px;"><table width="100" border="0" cellspacing="2" cellpadding="0">
												  ...
												  <tr>
													...
													<td>
												<img src="images/icon_view.gif" alt="View" class="pointer" width="18" height="18" border="0" title="View Content" onClick="JavaScript: CView_Click(document.frmStdForm, '<?php echo $a[$table_name . "_id"]; ?>');" />View</td>
													...
													?>
															...
															<td><img src="images/icon_visible.gif" alt="Hide"  class="pointer" title="Approve" onClick="JavaScript: CVisibleHide_Click(document.frmStdForm, '<?php echo $a[$table_name . "_id"]; ?>', '0');" width="18" height="18" border="0" /></td>
													...
													?>
															...
															<td><img src="images/icon_hide.gif" alt="Visible"  class="pointer" title="Disapprove" onClick="JavaScript: CVisibleHide_Click(document.frmStdForm, '<?php echo $a[$table_name . "_id"]; ?>', '1');" width="18" height="18" border="0" /></td>
...
*/
													...
													<?php
														...
														$flg = CheckForRelation($a[$table_name . "_id"], $dependency_table);
													...
													?>
														...
														<!--	<img src="images/icon_delete.gif" alt="Delete" width="18" height="18" border="0" /> -->
													...
													?>
														...
														<!--	<img src="images/icon_delete.gif" alt="Delete" class="pointer" width="18" height="18" border="0" title="Delete" onClick="JavaScript: CDelete_Click(document.frmStdForm, '<?php // echo $a[$table_name . "_id"]; ?>');" /> -->
								...
								<tr><td colspan="5" align="center">No <?php echo $title; ?> information available</td></tr>
							...
							?>
								  ...
								  <tr>
									...
									<td align="left">
										...
										<a href="JavaScript: CheckUncheck_Click(document.getElementsByName('pk_list[]'), true);" onMouseMove="window.status='Check All';" onMouseOut="window.status='';" class="textlink">Check All</a> /



										<a href="JavaScript: CheckUncheck_Click(document.getElementsByName('pk_list[]'), false);" onMouseMove="window.status='Uncheck All';" onMouseOut="window.status='';" class="textlink">Uncheck All</a>&nbsp;&nbsp;
                                        ...
                                        <img src="images/icon_visible.gif" title="Visible" class="pointer" onClick="JavaScript: CVisibleHideChecked_Click(document.frmStdForm, document.getElementsByName('pk_list[]'), 1);" />&nbsp;



										<img src="images/icon_hide.gif" title="Hide" class="pointer" onClick="JavaScript: CVisibleHideChecked_Click(document.frmStdForm, document.getElementsByName('pk_list[]'), 0);" />&nbsp;			<img src="images/icon_delete.gif" title="Delete" class="pointer" onClick="JavaScript: CDeleteChecked_Click(document.frmStdForm, document.getElementsByName('pk_list[]'));" />						</td>
