<?php 
  ...
  mysql_query("update donor_register_payment set donor_payment_status=1,donor_payment_data='".$_REQUEST['paypal_data']."',payer_id='".$_REQUEST['payer_id']."' where donor_register_payment_id =".$_REQUEST['item_number']);
