			...
			<div class="wrapper">
				...
				<div class="box1">
					...
					<div class="wrapper">
                        ...
                        <span style="text-align:center;font-size:24px; line-height:1.5;font-weight:bold; "> Thank you for registering to be a Donor with ETF, Your financial verification process Success</span></section>
